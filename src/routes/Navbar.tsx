...
import Logo from '/public/iconFin_X.png'
...
const Navbar = () => {
    ...
    return (
        <main className="bg-colorPrimary max-md:h-52 h-64 max-md:px-6 px-28 pt-5 flex flex-col gap-6">
            {/* NAVBAR */}
            <section className="flex items-end justify-between">
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-40 mr-6 border-none bg-colorTertiary">
                        {Rotas.map((rota, index) => (
                            <Link
                                key={index}
                                to={rota.path}
            ...
            <section className='flex max-md:gap-6 gap-20'>
                {/* RECEITAS */}
                <div className='bg-colorSecondary w-2/4 max-md:h-24 h-40 max-md:px-3 px-20 flex flex-col justify-center gap-1 rounded shadow-md'>
                    ...
                    <div className='flex items-center max-md:gap-2 gap-3'>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="max-md:size-6 size-14 stroke-colorGreen">
                ...
                <div className='bg-colorSecondary w-2/4 max-md:h-24 h-40 max-md:px-3 px-20 flex flex-col justify-center gap-1 rounded shadow-md'>
                    ...
                    <div className='flex items-center max-md:gap-2 gap-3'>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="max-md:size-6 size-14 stroke-colorRed">
